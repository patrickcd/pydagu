...
class TestDagBuilder:
    ...
    def test_ssh_and_mail_config(self):
...
class TestStepBuilder:
    ...
    def test_simple_step_with_retry(self):
    ...
    def test_step_with_docker_executor(self):
    ...
    def test_step_with_parallel_execution(self):
    ...
    def test_step_with_http_executor(self):
    ...
    def test_step_with_ssh_executor(self):
    ...
    def test_step_with_mail_executor(self):
    ...
    def test_step_with_shell_executor(self):
    ...
    def test_step_with_jq_executor(self):
    ...
    def test_step_with_working_dir(self):
    ...
    def test_step_with_precondition(self):
...
class TestIntegration:
    """Integration tests combining DagBuilder and StepBuilder"""

    def test_dag_with_prebuilt_steps(self):
